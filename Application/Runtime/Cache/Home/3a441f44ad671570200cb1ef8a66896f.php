					...
					<hr/>
						<div class="page-header">
							<form action="" id="upForm" method="post">
								...
								&nbsp;&nbsp;&nbsp;
								<input type="button" aname="d3" class="btn btn-small btn-white" value="数据上报"/> 
							</form>
						</div><!-- /.page-header -->
									...
									<div class="col-xs-12">
										<div class="table-responsive">
											...
											<table id="sample-table-1" class="table table-striped table-bordered table-hover">
												<tbody>
													<tr><td class="width-30">应上传体质人数</td><td><?php echo ($sch_status["s_cnt"]); ?></td></tr>
													...
													<tr><td>学校免体人数</td><td><?php echo ($sch_status["s_noceid_cnt"]); ?></td></tr>
													<tr><td>实际上传体质数据人数</td><td><?php echo ($sch_status["s_noceid_cnt"]); ?></td></tr>
