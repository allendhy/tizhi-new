					...
					<hr/>
						<div class="page-header">
							<form action="" id="downForm" method="get">
								...
								&nbsp;&nbsp;&nbsp;
								<input type="button" class="btn btn-small btn-white" value="查看"/> 
								<input type="button" class="btn btn-small btn-white"  value="下载"/>
							</form>
						</div><!-- /.page-header -->
									...
									<div class="col-xs-12">
										<div class="table-responsive">
											...
											<table id="sample-table-1" class="table table-striped table-bordered table-hover">
												<tbody>
													<tr><td class="width-30">总人数</td><td><?php echo ($sch_status["s_cnt"]); ?></td></tr>
													<tr><td>应受检人数(是指有全国学籍号且在学的人数)</td><td><?php echo ($sch_status["s_notinschool_cnt"]); ?></td></tr>
													<tr><td>未受检人数</td><td><?php echo ($sch_status['s_cnt'] - $sch_status['s_noceid_cnt']); ?></td></tr>
													<tr><td>上传率</td><td><?php echo ($sch_status["s_noceid_cnt"]); ?></td></tr>
													<tr><td>免体人数</td><td><?php echo ($sch_status["s_noceid_cnt"]); ?></td></tr>
												</tbody>
											</table>
